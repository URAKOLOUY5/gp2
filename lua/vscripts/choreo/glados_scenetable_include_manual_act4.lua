...
-- ****************************************************************************************************
	...
	if (curMapName=="sp_a4_tb_intro") then
	...
	if (curMapName=="sp_a4_tb_wall_button") then
	...
	if (curMapName=="sp_a4_tb_polarity") then
	...
	if (curMapName=="sp_a4_tb_catch") then
		-- classical music
		SceneTable["-4470_01" ] =
		{
...
-- ****************************************************************************************************
	...
	if (curMapName=="sp_a4_laser_catapult") then
	...
	if (curMapName=="sp_a4_laser_platform") then
		-- My facility...
		SceneTable["-4333_01" ] =
		{
...
-- ****************************************************************************************************
	...
	if (curMapName=="sp_a4_speed_tb_catch") then
	...
	if (curMapName=="sp_a4_jump_polarity") then
